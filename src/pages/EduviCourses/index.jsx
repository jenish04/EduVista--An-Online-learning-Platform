...
export default function EduviCoursesPage() {
  ...
  const EduviCourseOne = () => {
    Navigate("/eduvicoursesone");
  };
  return (
    <>
      <Helmet>
      ...
      <div className="flex flex-col items-center justify-start w-full gap-[100px] bg-gray-100">
        ...
        <div className="flex flex-col items-center justify-start w-full gap-[47px]">
          <div className="flex flex-row md:flex-col justify-start w-full gap-5 md:px-5 max-w-7xl">
            <Button color="white_A700" className="sm:px-5 font-medium min-w-[142px] rounded-[10px] custom-button hover:text-white hover:bg-yellow-200">
              All Courses
            </Button>
            <Button color="white_A700" className="font-medium min-w-[142px] rounded-[10px] custom-button hover:text-white hover:bg-yellow-200">
              Kindergarten
            </Button>
            <Button color="white_A700" className="sm:px-5 font-medium min-w-[142px] rounded-[10px] custom-button hover:text-white hover:bg-yellow-200">
              High School
            ...
            <Button color="white_A700" className="!text-deep_orange-400 font-medium min-w-[142px] rounded-[10px] custom-button hover:text-white hover:bg-yellow-200">
              More Courses
            </Button>
          </div>
            ...
            <div className="flex flex-col items-start justify-start w-full gap-[23px] md:px-5 max-w-7xl">
              ...
              <div className="flex flex-row justify-start w-full">
                <div className="w-full gap-10 grid-cols-4 md:grid-cols-2 md:gap-5 sm:grid-cols-1 grid">
                  <EduviCoursesOne className="flex flex-col items-center justify-start w-full custom-button" onClick={EduviCourseOne} />
